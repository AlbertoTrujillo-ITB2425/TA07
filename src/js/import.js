...
function parseCSV(csvText) {
    ...
    // Agregar la opción de seleccionar fecha
...
// Función para cargar los datos de la fila seleccionada
function loadDataForDate(parsedData, selectedDate) {
    ...
    if (row) {
        ...
        document.getElementById('energy-consumption').value = row[1]; // Consumo eléctrico
        ...
        document.getElementById('solar-panels').value = row[5]; // Número de paneles solares
        document.getElementById('solar-production').value = row[6]; // Producción solar por panel
        ...
        // Llamamos a la función para calcular la energía solar después de cargar los valores
        calculateSolarEnergy(periodType); // Este cálculo se mueve a otro archivo
    }
}
